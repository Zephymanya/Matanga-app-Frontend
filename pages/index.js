...
function Home() 
{
  ...
  {
    refAbout.current.scrollIntoView({behavior: "smooth", block: "start", inline: "nearest"});
  }
  ...
  <div className={styles.Home}>
    <header className={styles.header}>
      ...
      <div className={styles.textes_and_btn}>
        ...
        <Link href={rooter.login.link} className={styles.btn}>Connectez-vous</Link>
      </div>

      <MdOutlineArrowDropDownCircle className={styles.btn_arrow_down} onClick={handleGoDown}/>
    ...
    <div id="About" ref={refAbout} className={styles.About}>
      ...
      <div className={styles.textes_and_image}>
        ...
        <div className={`${styles.textes_and_btn} ${leftAnimation ? styles.animation : null}`} ref={textAnimate}>
          <p>
            ...
            le faux-texte dès qu'il est prêt ou que 
            la mise en page est achevée. Généralement, 
            on utilise un texte en faux latin, le 
            Lorem ipsum ou Lipsum.
          </p>

          <Link href={rooter.about.link} className={styles.btn}>en savoir plus</Link>
        </div>
      </div>
    </div>
    ...
    <div className={styles.MapBloc}>
      ...
      <div className={`${styles.bloc_textes} ${showTextBloc ? styles.show_text_bloc : null}`}>
        <div className={styles.texte}>
          <MdLocationOn className={styles.icon}/>
          <p>
            Av Boulevard du 30 juin , Kinshasa-Gombe République 
